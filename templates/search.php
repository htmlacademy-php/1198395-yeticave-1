        ...
        <section class="lots">
            ...
            if ($searchInfo['isCatValid'] && $searchInfo['isTextValid'] && isset($searchInfo['text'], $searchInfo['catId'], $searchInfo['catName'])) : ?>
                ...
                $searchLink = '/search.php?search=' . htmlspecialchars(
                        $searchInfo['text']
                    ) . '&cat=' . $searchInfo['catId']; ?>
                <h2>Все лоты в категории «<?= $searchInfo['catName'] ?>» по запросу «<span><?= htmlspecialchars(
                            $searchInfo['text']
                        ); ?></span>»</h2>
            <?php
            elseif ($searchInfo['isCatValid'] && isset($searchInfo['catId'], $searchInfo['catName'])) : ?>
                <?php
                $searchLink = '/search.php?&cat=' . $searchInfo['catId']; ?>
